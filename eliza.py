...
Original file is located at
    https://colab.research.google.com/drive/1HzBgt3Y4LUFzaEU34ztMBO8nMwlTmIP5
...
script = {
    "no": {"rank":1,"decomposition": r".*",
           "reassembly": [
               "Are you saying 'no' just to be negative?", 'You are being a bit negative', 'Why not']},
    "repeating": {"decomposition": r".*",
           "reassembly": ['What makes you think I am repeating myself?']},    
    "kidding": {"decomposition": r".*kidding me",
           "reassembly": ['Does it please you to believe I am kidding you?']},
    "wife": {"decomposition": r".*",
             "reassembly": ["Tell me more about your family"]},
    "maybe": {"decomposition": r".*",
             "reassembly": ["But your wife said you are optimistic?"]},
